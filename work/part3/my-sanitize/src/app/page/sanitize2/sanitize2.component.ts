...
export class Sanitize2Component implements OnInit {
  ...
  constructor(private sanitizer: DomSanitizer) {
    ...
    this.html = this.sanitizer.bypassSecurityTrustHtml('<h1>Sanitization</h1><script>console.log("I am alive. Yes!")</script>');
    ...
    // 쿠팡은 된다; 하지만 대 부분의 코드는 보안설정으로 수행되지 않는다.
    // https://www.google.com/ 사이트는 자기 콘텐츠를 다운받아서 iframe안에 베치하는 것을 허용하지 않는다.
    this.src = this.sanitizer.bypassSecurityTrustResourceUrl("http://yourheartbadge.co.kr/");
  }
